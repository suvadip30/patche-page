...
$output =  shell_exec("sudo -u root -S /bin/knife bootstrap '$field1' --ssh-user '$field3' --ssh-password '$field4' --sudo --use-sudo-password --node-name '$field2' --run-list 'recipe[patch_ubuntu]' --json-attributes '$field8' --node-ssl-verify-mode none > /tmp/password 2>&1");
